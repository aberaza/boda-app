...
export const mBauhaus = 'mask-image: ' + masks.bauhaus + '; -webkit-mask-image: ' + masks.bauhaus + ';';
export const mAlmohade = 'mask-image: ' + masks.almohade + '; -webkit-mask-image: ' + masks.almohade + ';';
